...
#if !defined( _VHDITOOLS_GETOPT_H )
#define _VHDITOOLS_GETOPT_H
...
typedef struct vhditools_option vhditools_option_t;

struct vhditools_option
{
...
#define vhditools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vhditools_getopt(
                  int argument_count,
...
void vhditools_getopt_wrapped_fprint(
      FILE *stream,
...
void vhditools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vhditools_option_t *options,
      int number_of_options );

int vhditools_getopt_get_options_string(
     const vhditools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VHDITOOLS_GETOPT_H ) */
