...
extern mount_handle_t *vhdimount_mount_handle;
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context VHDITOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes VHDITOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access VHDITOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options VHDITOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	VHDITOOLS_UNREFERENCED_PARAMETER( security_context )
	VHDITOOLS_UNREFERENCED_PARAMETER( file_attributes )
	VHDITOOLS_UNREFERENCED_PARAMETER( share_access )
	VHDITOOLS_UNREFERENCED_PARAMETER( creation_options )
