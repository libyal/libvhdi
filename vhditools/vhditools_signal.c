...
void (*vhditools_signal_signal_handler)( vhditools_signal_t ) = NULL;
...
{
	static char *function = "vhditools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( vhditools_signal_signal_handler != NULL )
			{
				vhditools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "vhditools_signal_attach";
	...
	vhditools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) vhditools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	vhditools_signal_initialize_memory_debug();
#endif
...
int vhditools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "vhditools_signal_detach";
	...
	vhditools_signal_signal_handler = NULL;
