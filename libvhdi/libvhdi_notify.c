...
{
	static char *function = "libvhdi_notify_set_stream";
...
int libvhdi_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvhdi_notify_stream_open";
...
int libvhdi_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvhdi_notify_stream_close";
