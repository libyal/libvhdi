...
#if !defined( _LIBVHDI_LIBCTHREADS_H )
#define _LIBVHDI_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBVHDI )
#define HAVE_LIBVHDI_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBVHDI_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBVHDI_LIBCTHREADS_H ) */
