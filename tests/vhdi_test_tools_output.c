...
#include "../vhditools/vhditools_output.h"

/* Tests the vhditools_output_initialize and function
 * Returns 1 if successful or 0 if not
 */
int vhdi_test_tools_output_initialize(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;

	result = vhditools_output_initialize(
	          _IONBF,
	          &error );
...
#endif
{
	...
	VHDI_TEST_RUN(
	 "vhditools_output_initialize",
	 vhdi_test_tools_output_initialize )

	/* TODO add tests for vhditools_output_copyright_fprint */

	/* TODO add tests for vhditools_output_version_fprint */

	/* TODO add tests for vhditools_output_version_detailed_fprint */
