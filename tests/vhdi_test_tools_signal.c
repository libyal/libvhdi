...
/* Tests the vhditools_signal_detach and function
 * Returns 1 if successful or 0 if not
 */
...
#endif
{
	...
	/* TODO add tests for vhditools_signal_handler */
#endif
