...
#if !defined( _VHDI_TEST_GETOPT_H )
#define _VHDI_TEST_GETOPT_H
...
#define vhdi_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vhdi_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VHDI_TEST_GETOPT_H ) */
